...
<tr>
<th><input type="number" name="no1" placeholder="Nombor Pertama" style="width:90%;height:30px;"></th>
</tr>
<tr>
<th><input type="number" name="no2" placeholder="Nombor Kedua" style="width:90%;height:30px;"></th>
</tr>
<tr>
<th><select name="operasi" style="width:90%;height:30px;">
